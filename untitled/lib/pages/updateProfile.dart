...
class _UpdateProfileState extends State<UpdateProfile> {
  final nameDecoration = InputDecoration(
      hintText: 'Enter Your Name',hintStyle: GoogleFonts.alice(color: Colors.white),
                    ...
                    Padding(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          ...
                          Auth.updateProfile(name : controller.text.trim(),context: context,image: image);
                          setState(() {
                            visibility = false;
                          });
                        ...
                        child: Padding(
                          ...
                          child: Text('Next',style: GoogleFonts.alice(fontSize: 16),),
                        ),
                        color: Colors.white,
                      ),
                    ),
