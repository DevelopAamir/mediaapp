...
import 'package:untitled/Brain/Auth.dart';
...
class _SignupState extends State<Signup> {
  ...
  final emailDecoration = InputDecoration(
      hintText: 'Enter Email',hintStyle: GoogleFonts.alice(color: Colors.white),
                          ...
                          children: [
                            Padding(
                              ...
                              child: MaterialButton(
                                ...
                                onPressed: () async{
                                  ...
                                  if(passwordController.text == confirmPasswordController.text){
                                   await Auth.signup(emailController.text.trim(), passwordController.text, context);
                                    ...
                                    Fluttertoast.showToast(msg: 'Password did not matched');
                                  }
                                  setState(() {
                                    visibility = false;
                                  });
                                ...
                                child: Padding(
                                  ...
                                  child: Text('Signup',style: GoogleFonts.alice(fontSize: 16),),
                                ),
                                color: Colors.white,
                              ),
                            ),
                            Padding(
                              ...
                              child: MaterialButton(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(15.0),
                                  child: Text('Go Back',style: GoogleFonts.alice(fontSize: 16),),
                                ),
                                color: Colors.white,
                              ),
                            ),
